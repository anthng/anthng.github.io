...
The section of the post will be organized following: The first is to go through the foundation of PCA quickly. Next, I'll implement PCA from scratch with Numpy. Finally, the visualization of data for PCA from scratch and from sklearn-module.
...
After the flipping sign, The result of **PCA** is the same as **sklearn**. And that's all, hope this was interesting.

This notebook can be downloaded [here [3]]()
